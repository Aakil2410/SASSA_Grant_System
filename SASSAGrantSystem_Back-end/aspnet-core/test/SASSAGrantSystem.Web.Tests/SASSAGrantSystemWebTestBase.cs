...
{
    public abstract class SASSAGrantSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SASSAGrantSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SASSAGrantSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SASSAGrantSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SASSAGrantSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SASSAGrantSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SASSAGrantSystemDbContext, Task<T>> func)
        {
            T result;
